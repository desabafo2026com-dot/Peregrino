...
// Cadastro de Romaria em Grupo (Rodada 24, pedido do usuário) — puramente
// informativo (nome do grupo, cidade de origem, quantidade de pessoas,
// data de início e previsão de dias), para que autoridades e outros
// peregrinos saibam de uma caravana em trânsito. Exige estar logado (o
// mesmo "com perfil de peregrino também" do pedido original) — mas não
// exige ter uma peregrinação individual planejada, é um cadastro à parte.
export default async function RomariaGrupoCadastroPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <VoltarButton href="/" />
      <h1 className="mb-1 text-2xl font-bold">Cadastrar Romaria em Grupo</h1>
